    ...
    public class ApplicationDbContext : IdentityDbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<UserResource>()
                .HasIndex(x => new { x.UserId, x.ResourceUnique }).IsUnique();
            modelBuilder.Entity<UserResource>().Property(x => x.ResourceUnique).HasMaxLength(255);
            modelBuilder.Entity<UserResource>().Property(x => x.DisplayName).HasMaxLength(255);
            ...
            modelBuilder.Entity<UserMod>().HasOne<Microsoft.AspNetCore.Identity.IdentityUser>()
                .WithMany().HasForeignKey(x => x.UserId).OnDelete(DeleteBehavior.Cascade);
            modelBuilder.Entity<UserResource>().HasOne<Microsoft.AspNetCore.Identity.IdentityUser>()
                .WithMany().HasForeignKey(x => x.UserId).OnDelete(DeleteBehavior.Cascade);
